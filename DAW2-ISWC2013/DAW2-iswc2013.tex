...
A comparison of our extensions with the original frameworks shows that we achieve better execution times, require less sub-queries and consequently engender less network traffic.
\end{enumerate}
