...
\begin{equation}
d = \max\limits_i S_i - \min\limits_i S_i.
\end{equation}
...
\hline
Diseasome 			& 18.6 	& 1 	& 95 & 10 & 1,500 		& 1 & 10 			& 91,122 & 9\\
DBLP 						& 39	& 2.8 	& 93 & 10 & 2,500 		& 1 & 10 			& 234,405 & 16\\
...
Star-shaped and path-shaped queries were defined as in~\cite{QTREE}: star-shaped queries (denoted $S-k$) has one variable as subject and contained k triple patterns. 
Path-shaped queries on the other hand were generated by using a random walk approach. 
...
\subsection{Results}
The RSMSE results are shown in Figure~\ref{fig:rsmse}.

\begin{figure*}
\centering
\begin{subfigure}[b]{0.45\textwidth}
                \centering
\includegraphics[width=\textwidth]{img/rsmse_query}
                \caption{RSMSE for query-wise dataset selection (vertical log scale)}
                \label{fig:rsmsequery}
        \end{subfigure}
~
\begin{subfigure}[b]{0.45\textwidth}
                \centering
\includegraphics[width=\textwidth]{img/rankmse_query}
                \caption{RankMSE for query-wise dataset selection}
                \label{fig:rankmsequery}
        \end{subfigure}

\begin{subfigure}[b]{0.45\textwidth}
                \centering
\includegraphics[width=\textwidth]{img/rsmse_subquery}
                \caption{RSMSE for subquery-wise dataset selection (vertical log scale)}
                \label{fig:rsmse_subquery}
        \end{subfigure}
~				
				\begin{subfigure}[b]{0.45\textwidth}
                \centering
\includegraphics[width=\textwidth]{img/rankmse_subquery}
                \caption{RankMSE for subquery-wise dataset selection}
                \label{fig:rankmse_subquery}
        \end{subfigure}
\caption{Mean squared errors with respect to result set evaluation and ranking}
\end{figure*}
